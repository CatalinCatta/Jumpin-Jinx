...
public static class Utils
{
    ...
    public static string DoubleToString(double number, bool withDecimals) =>
        number switch
        {
    ...
    public static (int, int) ResolutionIndexToTuple(int rez)
    {
        return rez switch
        {
            0 => (640, 360),
    ...
    public static int ResolutionTupleToIndex(Resolution rez)
    {
        return (rez.width, rez.height) switch
        {
            (640, 360) => 0,
